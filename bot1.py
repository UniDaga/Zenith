...
# Collect all PRIVATE_KEY_* from .env dynamically
PRIVATE_KEYS = [os.getenv(k) for k in os.environ if k.startswith("PRIVATE_KEY_") and os.getenv(k)]
if not PRIVATE_KEYS:
    raise Exception("❌ No PRIVATE_KEY_* found in .env file")
